...
(function() {
    ...
    /**
     * FYI - Rover edit below
     * Extole includes zeroclipboard and properly scopes it, but
     * this ID is hard-coded in to all zeroclipboard instances. The result
     * of it being that we cannot use zeroclipboard unless we edit the ids
     * of the elements below. This is nasty nasty nasty, but we won't
     * have to worry about conflicting zeroclipboard installs again.
     */
    var _bridge = function() {
        var flashBridge, len;
        var container = document.getElementById("global-zeroclipboard-html-bridge-rover");
        if (!container) {
            ...
            var html = '      <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="global-zeroclipboard-flash-bridge-rover" width="100%" height="100%">         <param name="movie" value="' + swfUrl + '"/>         <param name="allowScriptAccess" value="' + allowScriptAccess + '"/>         <param name="scale" value="exactfit"/>         <param name="loop" value="false"/>         <param name="menu" value="false"/>         <param name="quality" value="best" />         <param name="bgcolor" value="#ffffff"/>         <param name="wmode" value="transparent"/>         <param name="flashvars" value="' + flashvars + '"/>         <embed src="' + swfUrl + '"           loop="false" menu="false"           quality="best" bgcolor="#ffffff"           width="100%" height="100%"           name="global-zeroclipboard-flash-bridge-rover"           allowScriptAccess="' + allowScriptAccess + '"           allowFullScreen="false"           type="application/x-shockwave-flash"           wmode="transparent"           pluginspage="http://www.macromedia.com/go/getflashplayer"           flashvars="' + flashvars + '"           scale="exactfit">         </embed>       </object>';
            container = document.createElement("div");
            container.id = "global-zeroclipboard-html-bridge-rover";
            container.setAttribute("class", "global-zeroclipboard-container-rover");
        ...
        flashBridge = document["global-zeroclipboard-flash-bridge-rover"];
    ...
    _globalConfig.hoverClass = "zeroclipboard-is-hover-rover";
    _globalConfig.activeClass = "zeroclipboard-is-active-rover";
