...
class Thread(models.Model):
    ...
    def get_post_data(self, sort_method=None, user=None):
        ...
        for post in thread_posts:
            ...
            if post.deleted and post.post_type != 'question':
                continue
            author = post.author
            if not post.is_approved() and (author.is_watched() or author.is_suspended()):  # hide posts on the moderation queue
                continue
    ...
    def get_summary_html(self, search_state=None, visitor=None):
        ...
        # in zthe snippet so that tag urls match the search state
