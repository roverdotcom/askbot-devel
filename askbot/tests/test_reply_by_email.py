'''
    This module is suposed to test email functionality,
    but it s using a deprecated library (lamson) -> https://pypi.org/project/lamson/.
    It looks like only the tests are using this module so maybe the askbot owners will fix this part eventually.
'''
