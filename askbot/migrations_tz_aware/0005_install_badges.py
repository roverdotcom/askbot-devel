    ...
    if forum_app_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 2, 12, 29, 51, 920204, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
