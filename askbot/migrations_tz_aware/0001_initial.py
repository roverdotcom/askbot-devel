    ...
    def forwards(self, orm):
        ...
        if app_dir_name == 'forum':
            ...
            db.create_table('forum_validationhash', (
                ...
                ('expiration', self.gf('django.db.models.fields.DateTimeField')(default=timezone.datetime(2010, 4, 25, 13, 14, 41, 581000))),
    ...
    if app_dir_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 4, 25, 13, 14, 41, 714642)'}),
