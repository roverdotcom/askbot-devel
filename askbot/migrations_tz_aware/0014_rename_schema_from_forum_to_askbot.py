    ...
    if app_dir_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 6, 13, 23, 16, 4, 680070, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
