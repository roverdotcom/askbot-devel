    ...
    if forum_app_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 4, 25, 16, 24, 24, 604164, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
