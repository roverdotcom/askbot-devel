    ...
    if forum_app_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 16, 15, 7, 19, 596607, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
