    ...
    if forum_app_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 22, 21, 40, 30, 531379, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
