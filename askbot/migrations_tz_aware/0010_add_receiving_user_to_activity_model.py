...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 18, 11, 49, 24, 344026, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
