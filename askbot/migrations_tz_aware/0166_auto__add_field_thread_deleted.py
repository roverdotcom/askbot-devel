...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2013, 3, 10, 19, 4, 54, 674932, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2013, 3, 10, 19, 4, 54, 674702, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
