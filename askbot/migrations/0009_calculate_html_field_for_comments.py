    ...
    if forum_app_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 17, 15, 33, 45, 429877, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
