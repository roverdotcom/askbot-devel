...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mention', (
            ...
            ('mentioned_at', self.gf('django.db.models.fields.DateTimeField')(default=timezone.now)),
    ...
    if app_dir_name == 'forum':
        models = {
            ...
            'forum.mention': {
                ...
                'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
                'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
                'mentioned_at': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.now'}),
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 17, 13, 4, 34, 910299, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
