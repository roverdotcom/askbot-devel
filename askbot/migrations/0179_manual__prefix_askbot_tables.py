...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Prefix Askbot tables with 'askbot_'.
        db.rename_table('activity', 'askbot_activity')
        db.rename_table('award', 'askbot_award')
        db.rename_table('repute', 'askbot_repute')
        db.rename_table('tag', 'askbot_tag')
        db.rename_table('vote', 'askbot_vote')


    def backwards(self, orm):
        # Remove 'askbot_' prefix from tables that were previously missing it.
        db.rename_table('askbot_activity', 'activity')
        db.rename_table('askbot_award', 'award')
        db.rename_table('askbot_repute', 'repute')
        db.rename_table('askbot_tag', 'tag')
        db.rename_table('askbot_vote', 'vote')


    models = {
        'askbot.activity': {
            'Meta': {'object_name': 'Activity', 'db_table': "u'askbot_activity'"},
        ...
        'askbot.award': {
            'Meta': {'object_name': 'Award', 'db_table': "u'askbot_award'"},
        ...
        'askbot.repute': {
            'Meta': {'object_name': 'Repute', 'db_table': "u'askbot_repute'"},
        ...
        'askbot.tag': {
            'Meta': {'ordering': "('-used_count', 'name')", 'unique_together': "(('name', 'language_code'),)", 'object_name': 'Tag', 'db_table': "u'askbot_tag'"},
        ...
        'askbot.vote': {
            'Meta': {'unique_together': "(('user', 'voted_post'),)", 'object_name': 'Vote', 'db_table': "u'askbot_vote'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
