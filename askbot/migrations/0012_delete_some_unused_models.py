    ...
    if app_dir_name == 'forum':
        models = {
            ...
            'forum.validationhash': {
                ...
                'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'timezone.datetime(2010, 5, 29, 12, 2, 31, 449262, tzinfo=timezone.utc if getattr(settings, "USE_TZ", False) else None)'}),
