...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        """
        db.drop_foreign_key('Message', 'user_id')
        db.alter_column(
            'Message',
            'user_id',
            models.ForeignKey(to=orm['askbot.AskbotUser'])
        )
    ...
    def backwards(self, orm):
        ...
        db.alter_column(
            'Message',
            'user_id',
            models.ForeignKey(to=orm['auth.User'])
        )
    ...
    models = {
        ...
        'auth.message': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'_message_set'", 'to': "orm['askbot.AskbotUser']"})
        },
        u'auth.permission': {
